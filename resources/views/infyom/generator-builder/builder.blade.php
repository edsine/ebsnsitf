...
<script>
    ...
    $(function() {
        ...
        $(document).ready(function() {
            var htmlStr =
                '<tr class="item" style="display: table-row;"><th class="min-w-200px text-end rounded-end"></th></tr>';
            var commonComponent = $(htmlStr).filter("tr").load('{{ route('io_field_template') }}');
            var relationStr =
                '<tr class="relationItem" style="display: table-row;"><th class="min-w-200px text-end rounded-end"></th></tr>';
