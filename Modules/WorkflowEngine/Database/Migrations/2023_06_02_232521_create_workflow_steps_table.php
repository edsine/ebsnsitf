...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('workflow_steps', function (Blueprint $table) {
            ...
            $table->foreignId('parent_step_id')->constrained('workflow_steps')->onDelete('cascade');
            $table->foreignId('next_approved_id')->constrained('workflow_steps')->onDelete('cascade');
            $table->foreignId('next_rejected_id')->constrained('workflow_steps')->onDelete('cascade');
